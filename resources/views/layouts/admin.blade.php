...
<body class="bg-csj-gray-50" x-data="{ sidebarOpen: false }">
    ...
    <aside class="fixed inset-y-0 left-0 w-64 bg-csj-gray-900 text-white z-50 transform transition-transform duration-300 flex flex-col"
        ...
        {{-- Logo --}}
        <div class="flex items-center gap-3 px-6 py-5 border-b border-csj-gray-700 flex-shrink-0">
            <div class="w-10 h-10 rounded-xl flex items-center justify-center overflow-hidden">
                <img src="{{ asset('images/logo.png') }}" alt="CSJ" class="w-full h-full object-contain">
            </div>
            <div>
        ...
        {{-- Footer sidebar --}}
        <div class="flex-shrink-0 p-4 border-t border-csj-gray-700">
    ...
    <div class="lg:ml-64 min-h-screen flex flex-col">
        ...
        {{-- TOPBAR --}}
        <header class="bg-white border-b border-csj-gray-200 px-6 py-4 flex items-center justify-between flex-shrink-0">
            ...
            <div class="flex items-center gap-4">
                ...
                @if($unread > 0)
                    <a href="{{ route('admin.messages.index') }}"
                       class="relative flex items-center text-csj-gray-600 hover:text-csj-blue-600">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                        </svg>
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open" class="flex items-center gap-2 focus:outline-none">
                        <div class="w-9 h-9 rounded-full overflow-hidden flex-shrink-0">
                            ...
                            @else
                                <div class="w-9 h-9 rounded-full flex items-center justify-center" style="background-color: #0DCAF0;">
