...
<body class="bg-csj-gray-50" x-data="{ sidebarOpen: false }">
    ...
    {{-- SIDEBAR --}}
    <aside class="fixed inset-y-0 left-0 w-64 bg-csj-gray-900 text-white z-50 transform transition-transform duration-300"
        ...
        {{-- Navigation --}}
        <nav class="px-4 py-6 space-y-1 pb-36">
...
<header class="bg-white border-b border-csj-gray-200 px-6 py-4 flex items-center justify-between sticky top-0 z-30">
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-2">
            <div class="w-8 h-8 rounded-full flex items-center justify-center" style="background-color: #2DB9B5;">
